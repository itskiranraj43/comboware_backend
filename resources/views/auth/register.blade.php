            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endisset
                        ...
                        <div class="form-group row">
                            <label for="role" class="col-md-4 col-form-label text-md-right">{{ trans('cruds.user.fields.roles') }}</label>
                            <div class="col-md-6">
                                <select name="userrole" id="role" class="form-control {{ $errors->has('userrole') ? 'is-invalid' : '' }} select2" >
