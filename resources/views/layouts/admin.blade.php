...
<script>
  ...
  var value = $(this).data("id");
    $.ajax({
      url: '{{env("APP_URL")}}admin/image/delete/'+value,
      type: "GET",
      cors: true ,
      headers: {
